...
?>
		...
		<div class="cart-resume">
			<div class="detail">
				<div class="description"><?php echo esc_html__( 'Subtotal', 'checkout-mestres-wp' ); ?></div>
			...
			?>
			<div class="detail">
				<div class="description"><?php echo esc_html__( 'Shipping', 'checkout-mestres-wp' ); ?></div>
    ...
    ->get_coupons() as $code => $coupon): ?>
			<div class="detail">
				<div class="description"><?php echo esc_html__( 'Discount', 'checkout-mestres-wp' ); ?></div>
    ...
    ->display_prices_including_tax()): ?>
		...
		<?php } endforeach; ?>
			...
			<div class="detail total">
				<div class="description"><?php echo esc_html__( 'Total', 'checkout-mestres-wp' ); ?></div>
...
?>
						...
						<?php if(get_option('cwmp_floatcart_text_link')=="1"){ ?><a href="<?php echo esc_url($_product->get_permalink()); ?>"><?php } ?>
