	...
	?>
			<div class="cwmp_woo_checkout">
				...
				<div class="cwmp_woo_form_billing">
					<h2>
						<i class="fa <?php echo esc_html(get_option('cwmp_checkout_box_icon_dados_pessoais')); ?>"></i>
					...
					<p class="cwmp-form-row validate-required" id="cwmp_billing_name_field">
						<label for="cwmp_billing_name" class="screen-reader-text">
							<?php echo esc_attr_e('Full Name', 'checkout-mestres-wp'); ?>
							<abbr class="required" title="obrigatório">*</abbr>
						</label>
						<span class="woocommerce-input-wrapper">
							<input type="text" class="input-text" name="cwmp_billing_name" id="cwmp_billing_name" placeholder="<?php echo esc_attr_e('Full Name', 'checkout-mestres-wp'); ?>" value="<?php if($checkout->get_value('billing_first_name')){ echo esc_html($checkout->get_value('billing_first_name')); } ?><?php if($checkout->get_value('billing_last_name')){ echo " ".esc_html($checkout->get_value('billing_last_name')); } ?>" />
						</span>
						<span class="error hide"><?php echo esc_attr_e('Enter your full name', 'checkout-mestres-wp'); ?></span>
					</p>
					...
					<p class="cwmp-form-row" id="billing_cellphone_field">
						...
						<span class="woocommerce-input-wrapper">
							<input type="tel" class="input-text " name="billing_cellphone" id="billing_cellphone"  placeholder="<?php if(!get_option('cwmp_international_phone')=="1"){ echo esc_attr_e( 'Phone', 'checkout-mestres-wp'); } ?>" value="<?php echo esc_html($checkout->get_value('billing_cellphone')); ?>" autocomplete="off">
						</span>
						<span class="error hide"><?php echo esc_attr_e( 'Required field', 'checkout-mestres-wp'); ?></span>
					</p>
					...
					<p class="cwmp-form-row  validate-required" id="billing_email_field">
						...
						<span class="woocommerce-input-wrapper">
							<input type="text" class="input-text " name="billing_email" id="billing_email" placeholder="<?php echo esc_attr_e( 'E-mail', 'checkout-mestres-wp'); ?>" value="<?php echo esc_html($checkout->get_value('billing_email')); ?>" autocomplete="off" />
						</span>
						<span class="error hide"><?php echo esc_attr_e( 'Required field', 'checkout-mestres-wp'); ?></span>
					</p>
					...
					<p class="cwmp-form-row  validate-required" id="billing_gender_field">
						...
						<span class="woocommerce-input-wrapper">
						<select name="billing_gender" id="billing_gender" data-placeholder="<?php echo esc_html(get_option('billing_gender_label')); ?>" tabindex="-1" aria-hidden="true" autocomplete="off">
					...
					<p class="cwmp-form-row  validate-required" id="billing_birthdate_field">
						...
						<span class="woocommerce-input-wrapper">
							<input type="text" class="input-text " name="billing_birthdate" value="<?php echo esc_html($checkout->get_value('billing_birthdate')); ?>" id="billing_birthdate" placeholder="<?php echo esc_attr_e( 'Date of birth', 'checkout-mestres-wp'); ?>" autocomplete="off">
						</span>
						<span class="error hide"><?php echo esc_attr_e( 'Required field', 'checkout-mestres-wp'); ?></span>
					</p>
					...
					<p class="cwmp-form-row" id="billing_cpf_field">
						...
						<span class="woocommerce-input-wrapper">
							<input type="text" class="input-text " name="billing_cpf" id="billing_cpf" value="<?php echo esc_html($checkout->get_value('billing_cpf')); ?>" placeholder="<?php echo esc_attr_e( 'CPF', 'checkout-mestres-wp'); ?>" autocomplete="off">
						</span>
						<span class="error hide"><?php echo esc_attr_e( 'Required field', 'checkout-mestres-wp'); ?></span>
					</p>
					...
					<p class="cwmp-form-row" id="billing_rg_field">
						...
						<span class="woocommerce-input-wrapper">
							<input type="text" class="input-text " name="billing_rg" id="billing_rg" value="<?php echo esc_html($checkout->get_value('billing_rg')); ?>" placeholder="<?php echo esc_attr_e( 'RG', 'checkout-mestres-wp'); ?>" autocomplete="off">
						</span>
					</p>
					...
					<p class="cwmp-form-row <?php if($cwmp_brazilian['person_type']=="1"){ echo "hide"; } ?>" id="billing_cnpj_field">
						...
						<span class="woocommerce-input-wrapper">
							<input type="text" class="input-text " name="billing_cnpj" id="billing_cnpj" value="<?php echo esc_html($checkout->get_value('billing_cnpj')); ?>" placeholder="<?php echo esc_attr_e( 'CNPJ', 'checkout-mestres-wp'); ?>" autocomplete="off">
						</span>
						<span class="error hide"><?php echo esc_attr_e( 'Required field', 'checkout-mestres-wp'); ?></span>
					</p>
					...
					<p class="cwmp-form-row <?php if($cwmp_brazilian['person_type']=="1"){ echo "hide"; } ?>" id="billing_company_field">
						...
						<span class="woocommerce-input-wrapper">
							<input type="text" class="input-text " name="billing_company" id="billing_company" value="<?php echo esc_html($checkout->get_value('billing_company')); ?>" placeholder="<?php echo esc_attr_e( 'Business Name', 'checkout-mestres-wp'); ?>" autocomplete="off">
						</span>
					</p>
					...
					<p class="cwmp-form-row <?php if($cwmp_brazilian['person_type']=="1"){ echo "hide"; } ?>" id="billing_ie_field">
						...
						<span class="woocommerce-input-wrapper">
							<input type="text" class="input-text " name="billing_ie" id="billing_ie" value="<?php echo esc_html($checkout->get_value('billing_ie')); ?>" placeholder="<?php echo esc_attr_e( 'IE', 'checkout-mestres-wp'); ?>" autocomplete="off">
						</span>
					</p>
				...
				<div class="cwmp_woo_form_shipping ">
					<h2>
					<i class="fa <?php echo esc_html(get_option('cwmp_checkout_box_icon_entrega')); ?>"></i>
					<?php echo esc_html__( 'Address', 'checkout-mestres-wp'); ?>	
					...
					<div class="woocommerce-shipping-fields hide">
						<p class="cwmp-form-row  validate-required" id="billing_postcode_field">
							...
							<span class="woocommerce-input-wrapper">
								<input type="text" class="input-text " name="billing_postcode" id="billing_postcode" value="<?php echo esc_html($checkout->get_value('billing_postcode')); ?>" placeholder="<?php echo esc_attr_e( 'Code Postal', 'checkout-mestres-wp'); ?>">
							</span>
							<span class="error hide"><?php echo esc_attr_e( 'Required field', 'checkout-mestres-wp'); ?></span>
						</p>
						<p class="cwmp-form-row <?php if(get_option("cwmp_view_active_address_auto")=="S"){ ?>hide<?php } ?> validate-required" id="billing_address_1_field">
							...
							<span class="woocommerce-input-wrapper">
								<input type="text" class="input-text " name="billing_address_1" id="billing_address_1" value="<?php echo esc_html($checkout->get_value('billing_address_1')); ?>" placeholder="<?php echo esc_attr_e( 'Address', 'checkout-mestres-wp'); ?>">
							</span>
							<span class="error hide"><?php echo esc_attr_e( 'Required field', 'checkout-mestres-wp'); ?></span>
						</p>
						<p class="cwmp-form-row <?php if(get_option("cwmp_view_active_address_auto")=="S"){ ?>hide<?php } ?> validate-required" id="billing_number_field">
							...
							<span class="woocommerce-input-wrapper">
								<input type="text" class="input-text " name="billing_number" id="billing_number" value="<?php echo esc_html($checkout->get_value('billing_number')); ?>" placeholder="<?php echo esc_attr_e( 'Number', 'checkout-mestres-wp'); ?>">
							</span>
							<span class="error hide"><?php echo esc_attr_e( 'Required field', 'checkout-mestres-wp'); ?></span>
						</p>
						<p class="cwmp-form-row <?php if(get_option("cwmp_view_active_address_auto")=="S"){ ?>hide<?php } ?> validate-required" id="billing_neighborhood_field">
							...
							<span class="woocommerce-input-wrapper">
								<input type="text" class="input-text " name="billing_neighborhood" id="billing_neighborhood" value="<?php echo esc_html($checkout->get_value('billing_neighborhood')); ?>" placeholder="<?php echo esc_attr_e( 'Neighborhood', 'checkout-mestres-wp'); ?>">
							</span>
							<span class="error hide"><?php echo esc_attr_e( 'Required field', 'checkout-mestres-wp'); ?></span>
						</p>
						<p class="cwmp-form-row <?php if(get_option("cwmp_view_active_address_auto")=="S"){ ?>hide<?php } ?> validate-required" id="billing_address_2_field">
							...
							<span class="woocommerce-input-wrapper">
								<input type="text" class="input-text " name="billing_address_2" id="billing_address_2" value="<?php echo esc_html($checkout->get_value('billing_address_2')); ?>" placeholder="<?php echo esc_attr_e( 'Complement', 'checkout-mestres-wp'); ?>">
							</span>
						...
						<p class="cwmp-form-row <?php if(get_option("cwmp_view_active_address_auto")=="S"){ ?>hide<?php } ?> validate-required" id="billing_city_field">
							...
							<span class="woocommerce-input-wrapper">
								<input type="text" class="input-text " name="billing_city" id="billing_city" placeholder="<?php echo esc_attr_e( 'City', 'checkout-mestres-wp'); ?>" value="<?php echo esc_html($checkout->get_value('billing_city')); ?>">
							</span>
							<span class="error hide"><?php echo esc_attr_e( 'Required field', 'checkout-mestres-wp'); ?></span>
						</p>
						<?php
			...
			<div class="cwmp_woo_cart">
					<div class="title">
						<div>
							<h2><?php echo esc_attr_e( 'Resumo', 'checkout-mestres-wp'); ?> <span>(<?php echo wp_kses_post(wc_price(WC()->cart->total)); ?>)</span></h2>
							<p><?php echo esc_attr_e( 'Informações da sua compra', 'checkout-mestres-wp'); ?></p>
						</div>
						<div>
						<?php echo wp_kses_post(wc_price(WC()->cart->cart_contents_total)); ?>
				...
				<div class="box_form_coupon" >
					...
					<p class="cwmp-form-row cwmp-form-row-last">
						<button type="submit" class="button cwmp_button" name="apply_coupon" value="<?php esc_attr_e( 'Apply', 'checkout-mestres-wp' ); ?>">
							<svg width="20" height="17" viewBox="0 0 20 17" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
							<path d="M7.00004 16.42L0.790039 10.21L3.62004 7.38L7.00004 10.77L16.88 0.880005L19.71 3.71L7.00004 16.42Z" fill="currentColor"/>
							</svg>
						</button>
					</p>
				</div>
