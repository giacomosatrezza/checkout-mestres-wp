...
?>
        ...
        if ( 1 === count( $available_methods ) ) :
			...
			<div id="<?php echo esc_html($method->id); ?>" class="cwmp_method_shipping" <?php selected( $method->id, $chosen_method ); ?>>
				<div class="">
					<h4><?php echo esc_html($method->label); ?></h4>
				</div>
				<div class="">
					<span><?php if($method->cost=="0.00"){ echo "Grátis"; }else{ echo wp_kses_post(wc_price($method->cost)); } ?></span>
					<div class="active">
